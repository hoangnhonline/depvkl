            ...
            <div class="box-body">
              ...
              @endif              
                 <div class="form-group" style="margin-top:10px;margin-bottom:10px">  
                  ...
                  <div class="col-md-9">
                    <img id="thumbnail_image" src="{{ old('image_url') ? Helper::showImage(old('image_url')) : URL::asset('public/admin/dist/img/img.png') }}" class="img-thumbnail" width="600" >                    
                ...
                <div class="form-group">
                  ...
                  <select name="type" class="form-control" id="type">
                  	<option value="1" {{ old('type') == 1  ? "selected" : "" }}>No link</option>
                  	<option value="2" {{ old('type') == 2 ? "selected" : "" }}>Link</option>
                  </select>
                </div>  
